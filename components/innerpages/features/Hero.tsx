      ...
      <div className="section-outer panel pt-9 lg:pt-10 pb-6 xl:pb-9">
        <div className="container max-w-lg">
          <div className="section-inner panel mt-2 sm:mt-4 lg:mt-0">
            ...
            >
              <h1 className="h2 sm:h6 lg:display-6 xl:display-1 m-0">
                What Makes Us Stand Out.
              </h1>
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                We specialize in enhancing connectivity solutions, ensuring
                seamless data exchange and optimal performance for businesses of
                all sizes.
              </p>
            </div>
