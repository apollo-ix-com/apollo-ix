...
export const locations: Location[] = [
    ...
    { id: 8, lat: 51.2277, lng: 6.7735, name: 'Dusseldorf', type: 'own',organizations: 10, },
    ...
    { id: 26, lat: 19.0760, lng: 72.8777, name: 'Mumbai', type: 'enabled',organizations: 10, networks: 5, },
