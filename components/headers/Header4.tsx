  ...
  return (
    ...
    >
      ...
      >
              ...
              <div className="uc-navbar min-h-32px fs-8">
                ...
                <div className="uc-navbar-right">
                  <div className="uc-navbar-item">
                    <a className="btn btn-xs p-0 fs-8 text-white" href="tel:01032701349">
        ...
        <div style={{ "--uc-nav-height": "80px" } as React.CSSProperties} className="uc-navbar-main">
          <div className="container container-expand max-w-1440px">
            <div className="uc-navbar min-h-64px lg:min-h-80px text-gray-900 dark:text-white" style={{ position: "static" }}>
              <div className="uc-navbar-left">
              ...
              <div className="uc-navbar-right">
                ...
                {/* <Link className="btn btn-md btn-primary rounded-default lg:px-3 text-none shadow-xs d-none lg:d-inline-flex" href="/page-contact">
                  Send inquiry
                </Link> */}
